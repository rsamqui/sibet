...
<main id="main" class="main">
    ...
    <table class="table datatable">
        <thead>
        <tr>
            <th>ID Proveedor de Producto</th>
            <th>ID Producto</th>
            <th>ID Proveedor</th>
            <th>Opciones</th>
        ...
        <tr>
            ...
            <td>Arris DG2460</td>
            <td>
                <a href="/itemProvider-forms/read-itemProvider-form.html">
                    <button class="btn btn-primary w-45" type="button">Ver</button>
                </a>
                <a href="/itemProvider-forms/update-itemProvider-form.html">
                    <button class="btn btn-secondary w-45" type="button">Editar</button>
                </a>
                <a href="/itemProvider-forms/delete-itemProvider-form.html">
    ...
    <a href="/itemProvider-forms/create-itemProvider-form.html">
