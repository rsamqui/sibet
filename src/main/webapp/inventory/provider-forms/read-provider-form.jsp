...
<main id="main" class="main">
  ...
  <div class="card">
    <div class="card-body">
      <h5 class="card-title">Visualizando Proveedor</h5>

      <!-- Horizontal Form -->
      <form>
        <div class="row mb-3">
          <label for="inputEmail3" class="col-sm-2 col-form-label">Compañía</label>
          <div class="col-sm-10">
        ...
        <div class="row mb-3">
          <label for="inputEmail3" class="col-sm-2 col-form-label">Información de contacto</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="inputText" readonly>
          </div>
        </div>
        ...
        <div class="row mb-3">
          <label for="inputEmail3" class="col-sm-2 col-form-label">Número de teléfono</label>
          <div class="col-sm-10">
        ...
        <div class="text-center">
          <a href="../provider.jsp">
            <button class="btn btn-primary w-45" type="button">Atrás</button>
          </a>
