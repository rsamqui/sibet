...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Visualización de Proveedor de Producto</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Visualización de Proveedor de Producto</h5>

            <!-- Horizontal Form -->
            <form>
                <div class="row mb-3">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">ID Producto</label>
                    <div class="col-sm-10">
                ...
                <div class="row mb-3">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">ID Proveedor</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="inputText" readonly>
                    </div>
                </div>
