        ...
        <div class="card-body">
            ...
            <form method="post" novalidate>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="idType" id="idType" required="required">
                    </div>
                </div>

                <div class="row mb-3">
                    <label for="typeName" class="col-sm-2 col-form-label">Nombre</label>
                    <div class="col-sm-10">
                ...
                <div class="text-center">
                    <a href="slType?action=Agregar">
                        <button type="submit" name="action" value="Agregar" class="btn btn-primary">Crear</button>
                    </a>
