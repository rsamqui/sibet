<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
         pageEncoding="UTF-8" import="data.*, entities.tables.typeTable, java.util.*"%>
...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="../inventory/itemProvider.jsp">
        ...
        <div class="card-body">
            ...
            <table class="table datatable">
                ...
                <tr>
                    ...
                    <td><%=tt.getName()%></td>
                    <td>
                        <a href="../inventory/type-forms/read-type-form.jsp">
                            <button class="btn btn-primary w-30" type="button">Ver</button>
                        </a>
                        <a href="../inventory/type-forms/update-type-form.jsp">
                            <button class="btn btn-secondary w-30" type="button">Editar</button>
                        </a>
                        <a href="../inventory/type-forms/delete-type-form.jsp">
            ...
            <a href="../inventory/type-forms/create-type-form.jsp">
                <button class="btn btn-primary w-30" type="button">Agregar</button>
            </a>
