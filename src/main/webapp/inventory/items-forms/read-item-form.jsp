  ...
  <nav class="header-nav ms-auto">
    <ul class="d-flex align-items-center">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
        ...
        <li>
          <a class="dropdown-item d-flex align-items-center" href="${pageContext.request.contextPath}/Users/users-profile.html">
...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Visualización del Producto</h1>
    <nav>
      <ol class="breadcrumb">
  ...
  <div class="card">
    <div class="card-body">
      <h5 class="card-title">Visualización Producto</h5>
